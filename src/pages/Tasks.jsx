...
export default function Tasks(){
  ...
  return <div style={{padding:14, maxWidth:420, margin:'0 auto', background:'#000', minHeight:'100vh', color:'white', boxSizing:'border-box'}}>
    ...
    {/* FIXED: No more 404 - now scrolls to today's task */}
    <div onClick={()=>document.getElementById('today-task')?.scrollIntoView({behavior:'smooth'})} style={{display:'block', background:'linear-gradient(90deg,#0f7f8a,#6a3db5)', padding:10, borderRadius:12, color:'white', fontSize:13, fontWeight:'bold', textAlign:'center', marginBottom:12, cursor:'pointer'}}>
